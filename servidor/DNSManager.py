...
##$ORIGIN .
##$TTL 7200	; 2 hours
##1.40.10.in-addr.arpa	IN SOA	server.gob.gba.gov.ar. root.gob.gba.gov.ar. (
##				2011051000 ; serial
##				43200      ; refresh (12 hours)
